    ...
    <!-- ===============================================-->
     <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="#"><img class="img-fluid" src="assets/img/icons/logo.webp" alt="" width="80px" height="80px" /></a>
          ...
          <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav me-auto ms-lg-4 ms-xl-7 border-bottom border-lg-bottom-0 pt-2 pt-lg-0 ">
              <li class="nav-item "><a class="text-brown" aria-current="page" href="#">Accueil</a></li>
            </ul>
            <form class="d-flex py-3 py-lg-0"><a class="btn btn-light rounded-pill shadow fw-bold bg-brown" href="login.php" role="button">Connexion Admin
      ...
      <section class="py-5 loko">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-5 col-lg-7 order-md-1 pt-8"><img class="img-fluid" src="assets/img/illustrations/7.webp" alt="" width="1000px" height="1000px" /></div>
      ...
      <section class="py-6 pb-0" style="background-color:#faaf3f;">
        ...
        <div class="container">
          ...
          <div class="row justify-content-lg-around">
            <div class="col-12 col-sm-12 col-lg-3 mb-4 order-0 order-sm-0"><a class="text-decoration-none" href="#"><img class="img-fluid me-3" src="assets/img/icons/logo.webp" alt=""width="150px" height="450px" /><span class="fw-bold fs-1 text-1000">Réchauffement climatique</span></a>
            </div>
            ...
            <div class="col-12 col-sm-4 col-lg-3 mb-3 order-1 order-sm-3">
              ...
              <ul class="list-unstyled mb-md-4 mb-lg-0">
                ...
                <li class="list-inline-item"><a class="text-dark fs--1 text-decoration-none" href="#!"><img class="img-fluid" src="assets/img/icons/f.png" width="40px" height="40px" alt="" /></a></li>
                <li class="list-inline-item"><a class="text-dark fs--1 text-decoration-none" href="#!"><img class="img-fluid" src="assets/img/icons/t.png" width="40px" height="40px" alt="" /></a></li>
                <li class="list-inline-item"><a class="text-dark fs--1 text-decoration-none" href="#!"><img class="img-fluid" src="assets/img/icons/i.png" width="40px" height="40px" alt="" /></a></li>
